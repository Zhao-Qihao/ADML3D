...
```
notice that there are 5 classes in my custom dataset, ['car','truck','bus','bicycle','pedestrian'], you can change the class name in [custom_scene_converter.py](./tools/dataset_converters/custom_scene_converter.py#L8-L9) and [custom_dataset.py](./projects/BEVFusion/datasets/custom_dataset.py#L42-L45) to fit your dataset.
