...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file=info_directory_path + "nuscenes_mini_infos_train.pkl",
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file=info_directory_path + "nuscenes_infos_val.pkl",
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        # ann_file=info_directory_path + "nuscenes_infos_val_updated.pkl",
        ann_file=info_directory_path + "nuscenes_mini_infos_val.pkl",
        pipeline=test_pipeline,
        seq_split_num=1,
        metainfo=metainfo,
        # class_names=class_names,
